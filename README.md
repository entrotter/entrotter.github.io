...
SHA-256 hashes and renders fixture reports only; EVM rendering remains a scoped
contribution issue. The SDK/CLI can inspect EVM artifacts when execution succeeds.
...
assets, schemas and synthetic reports. It never uploads the repository root,
